...
- The first version recovers failed one-time payments only. Checkout drop-off, failed subscriptions, B2B receivables, mandate retry sequencing, generated voice recovery, promise-to-pay / udhaar tracking, merchant chat, and multi-merchant authentication are planned after that loop; see `PLAN.md` Steps 17–22. A public product landing is planned as Step 23.
